      ...
      <div className="rounded-lg border border-[#2d2d30] bg-[#252526]/80 backdrop-blur-md shadow-2xl p-5 sm:p-7 space-y-5">
        ...
        <div className="space-y-1 text-center sm:text-left">
          ...
          <p className="text-xs text-[#858585]">
            Join CodeSync to start real-time collaborative coding sessions.
          </p>
        </div>
        ...
        <div className="relative flex items-center justify-center">
          ...
          <span className="relative px-3 bg-[#252526] text-[11px] text-[#858585] uppercase tracking-wider">
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <div className="space-y-1.5">
            <label
              ...
              className="font-medium text-[#cccccc] block text-xs"
            >
              Password <span className="text-[#858585] font-normal">(5-8 characters)</span>
            </label>
            ...
            {password.length > 0 && passwordStrength && (
              <div className="mt-1.5 space-y-1">
                <div className="flex items-center justify-between text-[10px]">
                  <span className="text-[#858585]">Password strength:</span>
